...
def export_models(
    ...
    mimi_state = init_states(
        tts_model.mimi, batch_size=1, sequence_length=STATIC_SEQ_LEN
    )
    ...
    # NOTE: patch disabled - was causing issues with ONNX Runtime
    # from onnx_export.export_utils import fix_expand_shapes
    # try:
    #     fix_expand_shapes(model_path=mimi_onnx_path)
    #     print("Applied Expand-shape patch to mimi_decoder.onnx")
    # except Exception as e:
    #     print(f"Warning: failed to patch mimi_decoder.onnx: {e}")
